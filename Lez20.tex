...
\subparagraph{Step I.} 
Scegliamo un opportuno \vir{cavallo} (come studiato precedentemente).
...
e si ottennero i risultati in Figura \ref{0421_Se}: il fattore astrofisico è stato normalizzato con i dati raccolti nel range di energie tra 600 keV e 1 MeV; osserviamo che il THM non riesce a prevedere l'effetto dell'elettroscreening\index{elettroscreening}. Possiamo comunque ricavarlo, ottenendo così $U_e^{th}=186$ eV$\ll U_e = (340\pm 51)$ eV.
...
Prendiamo uno stato legato $E<0$ e definiamo $k\in \mathbb{C}$ tale $E\equiv \hbar^2 k^2 / 2\mu$, da cui $k = i\, \sqrt{2\mu |E|/\hbar^2} \equiv i\,k_I$ con $k_I\in \mathbb{R}$.%! Ma se prendo uno stato legato ho le soluzioni di COulomb poi?
...
$$I_{bc,\ell s}^a (r) = \frac{C_{\ell s}}{r} \, W_{-\eta,\ell+1/2} (2kr)$$%! che vuol dire -\eta ? 
