...
\begin{itemize}
    \item \textbf{prolata}\index{figura!prolata} $\Rightarrow \; \beta >0$, Figura
    \item \textbf{oblata}\index{figura!oblata} $\Rightarrow \; \beta <0$, Figura
\end{itemize}
