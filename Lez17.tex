...
Le ultime, \eqref{0414_funz3}, sono dette funzioni di Lagrange\index{funzioni di Lagrange}, i $P_N$ sono i polinomi di Legendre\index{polinomi di Legendre} e gli $x_i$ i loro zeri; l'esponente $n$ viene spesso preso $n\sim 1$\\
...
%! Da ora in poi io non ho ben capito quali sono i fenomeni di background
