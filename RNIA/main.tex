...
%	base agli argomenti e segue l'esposizione adottata a 
%	lezione. Per ogni file importato è riportata nel main 
%	la descrizione del contenuto
%------------------------------------------------------------%
%--------------------------RELEASES--------------------------%
%
%	: v23-06.2 :
%		* Tolto il comando `\acc`
%		* Correzione titolo in Lez7 (BBN) 		
%		* Correzione footnote in Lez8 (elio 4) 		
%------------------------------------------------------------%
%%
...
\author{Bernardo Vettori\\ \normalsize email: \href{mailto:bernardo.vettori@outlook.it}{bernardo.vettori@outlook.it}}
\date{A.A. 2020/2021}
...
Questo lavoro è totalmente personale e non ha alcuna validità in relazione all'esame dal momento che non è né stato controllato né approvato dalla docente.
...
\input{Lez1.tex}    %   15/02
%%  Modello a shell
\input{Lez2.tex}    %   01/03
%%  Modello a goccia e decadimento beta
\input{Lez3.tex}    %   03/03
%%  Teoria di Fermi sul decadimento beta e
%   decadimenti permessi e proibiti
\input{Lez4.tex}    %   04/03
%%  Decadimento gamma
\input{Lez5.tex}    %   08/03
%%  Conclusione del decadimento gamma e 
%   alcuni esempi
\input{Lez6.tex}    %   10/03
%%  Introduzione alla BBN
\input{Lez7.tex}    %   11/03
%%  Network della BBN
\input{Lez8.tex}    %   15/03
%%  La prima reazione
\input{Lez9.tex}    %   17/03
%%  Meson-Exchange Current 
%   Introduzione alla pp
%   Metodo ab-initio
\input{Lez10.tex}    %   18/03
%%  Il problema dei \nu Solari
%   Reaction rate
\input{Lez11.tex}    %   22/03
%%  Fine Reaction rate
%   Fattore astrofisico
\input{Lez12.tex}    %   24/03
%%  Risonanza
\input{Lez13.tex}    %   25/03
%%  Elettroscreening
\input{Lez14.tex}    %   29/03
%%  Studio pp con Ab Initio
%   Articolo di Bethe
\input{Lez15.tex}    %   31/03
%%  Intro R-Matrix
%   RM Calculable
\input{Lez16.tex}    %   12/04
%%  R-Matrix e Tecniche di Misura
%   RM Phenomenological
%   Intro Tecniche sperim
%   Metodi Diretti
%   Raggi cosmici e Radon
\input{Lez17.tex}    %   14/04
%%  Tecniche di Misura
%   LUNA
%   Il problema dell'elettroscreening, he\alpha
%   ATOMKY Anomaly
%   ERNA, Recoil mass separator
\input{Lez18.tex}    %   15/04
%%  Tecniche di Misura
%   Metodi Indiretti
%   CD method
%   TH method
\input{Lez19.tex}    %   19/04
%%  Tecniche di Misura e Ultime reazioni
%   Metodi Indiretti
%   TH  method
%   ANC method
%   3\alpha
\input{Lez20.tex}    %   21/04
%%  Ultime reazioni
%   Ciclo CN-NO
%       CNO & NO 
%       Reazione più lenta
\input{Lez21.tex}    %   22/04
%%  Ultime reazioni
%   Holy Grail 
%       risonanza ossigeno ed esperimenti
\input{Lez22.tex}    %   26/04
%%  Ultime reazioni
%   Holy Grail 
%       O(\alpha,\gamma)Ne
%       Ultime reazioni nellle stelle
\input{Lez23.tex}    %   28/04
%% Complementi
\input{Complementi.tex}
