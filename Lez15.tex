...
Così facendo Bethe trovò $\Lambda^2 = 8.08 \div 5.93$ e un fattore astrofisico\index{fattore astrofisico@fattore astrofisico $S(E)$} $S = (4.61 \div 3.38)\cdot\ord{-25}$ MeVb. I risultati\footnote{\acc{E} interessante osservare che il neutrino fu teorizzato proprio nel 1938 e Bethe ne tiene di conto, tuttavia non lo riporta.} globali sono riportati in Tabella \ref{0331_tab}.
\begin{figure}[h]
    \centering
